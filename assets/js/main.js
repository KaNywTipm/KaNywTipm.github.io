...
const I18N_DICT = {
  en: {
    ...
    "download.transcript": "Transcript",
  ...
  th: {
    ...
    "download.resume": "เรซูเม่",
    "download.transcript": "ใบแสดงผลการศึกษา",
    ...
    "about.note": "หากสนใจติดต่อได้ทางอีเมลส่วนตัว จะตอบกลับโดยเร็วที่สุด",
